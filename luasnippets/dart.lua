...
return {
  ...
  s("stfulHookConsumer", {
    t("class "),
    i(1, "MyWidget"),
    t(" extends StatefulHookConsumerWidget {"),
    t({ "", "\tconst " }),
    rep(1),
    t("({super.key});"),
    t({ "", "\t@override", "\tConsumerState<ConsumerStatefulWidget> createState() => _" }),
    rep(1),
    t("State();"),
    t({ "", "}", "", "class _" }),
    rep(1),
